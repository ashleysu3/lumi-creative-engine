...
export const BrandSystemSchema = z.object({
  colors: z.object({ primary: z.array(z.string()).default([]), secondary: z.array(z.string()).default([]), accent: z.array(z.string()).default([]), background: z.array(z.string()).default([]), prohibited: z.array(z.string()).default([]) }),
  typography: z.object({ headlineFamily: z.string().optional(), bodyFamily: z.string().optional(), accentFamily: z.string().optional(), allowedWeights: z.array(z.number()).default([]), notes: z.array(z.string()).default([]) }),
  photography: z.object({ founderLed: z.boolean().default(false), styleNotes: z.array(z.string()).default([]), avoid: z.array(z.string()).default([]) }),
  logoAssetIds: z.array(z.string()).default([]), motifs: z.array(z.string()).default([]), avoid: z.array(z.string()).default([])
});
...
export const CreativeBriefSchema = z.object({
  ...
  brandAdaptation: z.object({ colors: z.array(z.string()).default([]), headlineFont: z.string().optional(), bodyFont: z.string().optional(), photoTreatment: z.string().optional(), motifs: z.array(z.string()).default([]) })
});
